...
local math = { abs = math.abs, floor = math.floor, log10 = math.log10, min = math.min }
	...
	function bat.update()
		...
		for i, battery in ipairs(batteries) do
			...
			if tonumber(present) == 1 then
				...
				local energy_full = tonumber(first_line(bstr .. "/energy_full") or first_line(bstr .. "/charge_full"))

				local energy_percentage = tonumber(first_line(bstr .. "/capacity"))
